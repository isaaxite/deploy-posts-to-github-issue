...
export class AssetPublisher {
  ...
  #setPushHooks(pushHooks) {
    if (!pushHooks || Object.prototype.toString.call(pushHooks) !== '[object Object]') {
      return;
    }

    for (const key of Object.keys(this.#pushHooks)) {
      if (['[object Function]', '[object AsyncFunction]'].includes(
        Object.prototype.toString.call(pushHooks[key])
      )) {
